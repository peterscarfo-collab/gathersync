import type { Event, Participant, EventSnapshot, GroupTemplate, InfluencerProspect, ConferenceSession, SessionKind } from '@/types/models';
        ...
        Promise.all(
          events.map(async (event) => {
            ...
            return {
              ...
              showAttendeePhones: event.showAttendeePhones,
              ...
              sessions: sessions.map((s) => ({
                ...
                eventId: s.eventId,
                title: s.title,
                kind: (s.kind as SessionKind | null) ?? 'talk',
                date: s.date,
                startTime: s.startTime,
                endTime: s.endTime,
                room: s.room ?? undefined,
                speaker: s.speaker ?? undefined,
                speakerTopic: s.speakerTopic ?? undefined,
