    ...
    const handleCallback = async () => {
      ...
      try {
        ...
        if (params.sessionToken) {
          ...
          setStatus("success");
          console.log("[OAuth] Web authentication successful");
          
          // DISABLED: Automatic sync on login to prevent race conditions
          // User must manually tap "Sync Now" button
          // syncLocalToCloud().then((result) => {
          //   console.log("[OAuth] Sync completed:", result);
          // }).catch((error) => {
        ...
        if (sessionToken) {
          ...
          setStatus("success");
          console.log("[OAuth] Redirecting to home, syncing data...");
        ...
        // Exchange code for session token via API server
        ...
        if (result.sessionToken) {
          ...
          setStatus("success");
          console.log("[OAuth] Authentication successful, syncing data...");
