    ...
    <DesktopLayout>
      <View style={styles.container}>
        ...
        <ScrollView ref={scrollViewRef} style={styles.content} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.listItem}><ThemedText style={styles.listBullet}>-</ThemedText><ThemedText style={styles.paragraph}>  <ThemedText style={{fontWeight: "bold"}}>Send Messages (SMS/Email):</ThemedText> Select participants and send an SMS, Native Email (Bcc in your mail app), or App Email (GatherSync sends from the app). Use <ThemedText style={{fontWeight: "bold"}}>Meeting update</ThemedText> when re-sending after a time, date, or link change.</ThemedText></View>
          ...
          <View onLayout={handleLayout('option-b-send-messages-sms-or-native-email')}><ThemedText style={styles.h3}>Option B: Send Messages (SMS, Native Email, or App Email)</ThemedText></View>
          ...
          <View style={styles.listItem}><ThemedText style={styles.listBullet}>•</ThemedText><ThemedText style={styles.paragraph}>Filter participants (e.g., Select All, Attending, No Response).</ThemedText></View>
          <View style={styles.listItem}><ThemedText style={styles.listBullet}>•</ThemedText><ThemedText style={styles.paragraph}>Choose <ThemedText style={{fontWeight: "bold"}}>Send SMS</ThemedText>, <ThemedText style={{fontWeight: "bold"}}>Native Email</ThemedText>, or <ThemedText style={{fontWeight: "bold"}}>App Email</ThemedText>.</ThemedText></View>
          <View onLayout={handleLayout('option-b-meeting-updates')}><ThemedText style={styles.h3}>Sending a meeting update (time, link, or venue change)</ThemedText></View>
          <ThemedText style={styles.paragraph}>When something changes after the original invite — for example moving a Zoom from 4:00pm to 3:30pm — people may ignore a second email that looks like the first invitation. GatherSync fixes this with <ThemedText style={{fontWeight: "bold"}}>Meeting update</ThemedText> on the Send Messages screen:</ThemedText>
          <View style={styles.listItem}><ThemedText style={styles.listBullet}>•</ThemedText><ThemedText style={styles.paragraph}>Edit the event with the new details first.</ThemedText></View>
          <View style={styles.listItem}><ThemedText style={styles.listBullet}>•</ThemedText><ThemedText style={styles.paragraph}>Open <ThemedText style={{fontWeight: "bold"}}>Send Messages</ThemedText> and turn on <ThemedText style={{fontWeight: "bold"}}>Meeting update</ThemedText> (it turns on automatically after you have sent App Email once for that event).</ThemedText></View>
          <View style={styles.listItem}><ThemedText style={styles.listBullet}>•</ThemedText><ThemedText style={styles.paragraph}><ThemedText style={{fontWeight: "bold"}}>App Email:</ThemedText> subject becomes <ThemedText style={{fontStyle: "italic"}}>UPDATE — [Event name] (details changed)</ThemedText> and the email shows an orange <ThemedText style={{fontWeight: "bold"}}>MEETING UPDATE</ThemedText> banner.</ThemedText></View>
          <View style={styles.listItem}><ThemedText style={styles.listBullet}>•</ThemedText><ThemedText style={styles.paragraph}><ThemedText style={{fontWeight: "bold"}}>SMS &amp; Native Email:</ThemedText> the message starts with <ThemedText style={{fontStyle: "italic"}}>UPDATE — meeting details have changed</ThemedText> so the change is obvious in the preview.</ThemedText></View>
          <View style={styles.listItem}><ThemedText style={styles.listBullet}>•</ThemedText><ThemedText style={styles.paragraph}>Turn <ThemedText style={{fontWeight: "bold"}}>Meeting update</ThemedText> off only if you are sending a true first invite (e.g. new participants who never received the original).</ThemedText></View>
