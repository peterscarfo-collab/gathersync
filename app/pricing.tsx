    ...
    try {
      ...
      const result = await createCheckout.mutateAsync({
        ...
        successUrl: Platform.OS === 'web'
          ? `${WEB_BASE_URL}/subscription-success.html`
          : `${WEB_BASE_URL}/subscription-success.html?scheme=${encodeURIComponent(APP_SCHEME)}`,
        cancelUrl: Platform.OS === 'web'
          ? `${WEB_BASE_URL}/pricing.html`
          : `${WEB_BASE_URL}/index.html`,
      });
